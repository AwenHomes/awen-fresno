...
function ShareButtons() {
  ...
  const shareText = encodeURIComponent(
    "I just found out what PG&E rate hikes are really costing me. Get your free personalized solar report →"
  );
  ...
  return (
    <div className="fade-up fade-d2" style={{
      background: D.card, border: `1px solid ${D.border}`, borderRadius: 16,
      padding: "24px 28px", marginBottom: 28, textAlign: "center",
    }}>
      <p style={{ color: D.textSub, fontSize: 12, fontWeight: 700, letterSpacing: "1.2px", textTransform: "uppercase", marginBottom: 14 }}>
        Know someone tired of high PG&amp;E bills?
      </p>
      <p style={{ color: D.text, fontSize: 15, lineHeight: 1.6, marginBottom: 20 }}>
        Share this free report tool with friends and family in the Fresno area.
      </p>
